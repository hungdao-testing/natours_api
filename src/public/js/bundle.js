...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoibmFydXRvb25lIiwiYSI6ImNsMjA4ZjFjZzAwNGgzYm51ODV6dDhkeXYifQ.7VYvKm5lLDMaGt_mZPbEpA';
...
},{}],"env.config.js":[function(require,module,exports) {
"use strict";
        ...
        switch (_context.prev = _context.next) {
          case 0:
            ...
            return (0, _axios.default)({
              method: 'POST',
              url: "http://127.0.0.1:".concat(port, "/api/v1/users/login"),
              data: {
                email: email,
                password: password
              }
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            ...
            return (0, _axios.default)({
              method: 'GET',
              url: "http://127.0.0.1:".concat(port, "/api/v1/users/logout")
            });
...
},{"axios":"../../../node_modules/axios/index.js","./alerts":"alerts.js","./env.config":"env.config.js"}],"updateSettings.js":[function(require,module,exports) {
"use strict";
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            url = type === 'password' ? "http://127.0.0.1:".concat(port, "/api/v1/users/updateMyPassword") : "http://127.0.0.1:".concat(port, "/api/v1/users/updateMe");
            _context.next = 4;
            return (0, _axios.default)({
              method: 'PATCH',
              url: url,
...
},{"axios":"../../../node_modules/axios/index.js","./alerts":"alerts.js","./env.config":"env.config.js"}],"index.js":[function(require,module,exports) {
"use strict";
