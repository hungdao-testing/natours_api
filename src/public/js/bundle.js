parcelRequire = (function (e, r, t, n) {
...
})(
  {
    ...
    '8zrW': [
      ...
      { './_descriptors': '+1KZ', './_fails': 'fbBX', './_dom-create': '+Fgv' },
    ],
    bFBK: [
      function (require, module, exports) {
    ...
    dbww: [
      ...
      { './_core': 'HIea', './_global': 'h3Gt', './_library': '9VD9' },
    ],
    OyaL: [
      function (require, module, exports) {
    ...
    FPEW: [
      ...
      { './_is-object': 'Hb36', './_is-array': '2HaH', './_wks': 'hdTv' },
    ],
    zgnn: [
      function (require, module, exports) {
    ...
    SlOi: [
      ...
      { './_object-dp': 'hYd+', './_property-desc': 'BqL0' },
    ],
    dcYf: [
      function (require, module, exports) {
        var e = require('./_cof'),
    ...
    nr8P: [
      ...
      { './_object-keys-internal': '/1XJ', './_enum-bug-keys': '/EVN' },
    ],
    '+17n': [
      function (require, module, exports) {
        var e = require('./_object-dp'),
    ...
    pyPl: [
      ...
      { './_object-dp': 'hYd+', './_has': 'ROQC', './_wks': 'hdTv' },
    ],
    oK9M: [
      function (require, module, exports) {
        'use strict'
    ...
    v87J: [
      ...
      { './_has': 'ROQC', './_to-object': 'loGD', './_shared-key': 'HO+o' },
    ],
    I9rZ: [
      function (require, module, exports) {
        'use strict'
    ...
    kO8w: [
      ...
      { './_object-dp': 'hYd+', './_descriptors': '+1KZ' },
    ],
    '90PL': [
      function (require, module, exports) {
    ...
    SWCJ: [
      ...
      { './_is-object': 'Hb36', './_set-proto': 'WQG+' },
    ],
    zKRC: [
      function (require, module, exports) {
        'use strict'
    ...
    N2rY: [
      ...
      { './_export': 'L1Pz', './_math-expm1': '3eWd', './_fails': 'fbBX' },
    ],
    cgNK: [
      function (require, module, exports) {
        var r = require('./_export'),
    ...
    '/4A2': [
      ...
      { './_library': '9VD9', './_fails': 'fbBX', './_global': 'h3Gt' },
    ],
    '46Z3': [
      function (require, module, exports) {
        'use strict'
    ...
    aNgU: [
      ...
      { './_export': 'L1Pz', './_object-to-array': '/lSc' },
    ],
    'Nl5/': [
      function (require, module, exports) {
        var e = require('./_export'),
    ...
    yoMt: [
      ...
      { './_is-object': 'Hb36', './_meta': 'aoG9', './_object-sap': 'Nl5/' },
    ],
    '55hx': [
      function (require, module, exports) {
    ...
    FmSW: [
      ...
      { './_object-sap': 'Nl5/', './_object-gopn-ext': 'kONq' },
    ],
    eKPx: [
      function (require, module, exports) {
        var e = require('./_to-object'),
    ...
    hoz0: [
      ...
      { './_is-object': 'Hb36', './_object-sap': 'Nl5/' },
    ],
    qCTx: [
      function (require, module, exports) {
        var e = require('./_is-object')
    ...
    Nhpu: [
      ...
      { './_an-object': 'gBlm', './_a-function': 'wN/2', './_wks': 'hdTv' },
    ],
    SziI: [
      function (require, module, exports) {
    ...
    nzVC: [
      ...
      { './_global': 'h3Gt', './_task': 'dW5F', './_cof': '6fDU' },
    ],
    wRya: [
      function (require, module, exports) {
        'use strict'
    ...
    'F+dY': [
      ...
      { './_a-function': 'wN/2', './_is-object': 'Hb36', './_invoke': 'SziI' },
    ],
    'E/yi': [
      function (require, module, exports) {
        var e = require('./_export'),
    ...
    nsQg: [
      ...
      { './_is-object': 'Hb36', './_cof': '6fDU', './_wks': 'hdTv' },
    ],
    jDBp: [
      function (require, module, exports) {
        'use strict'
    ...
    UHTP: [
      ...
      { './_descriptors': '+1KZ', './_object-dp': 'hYd+', './_flags': 'jDBp' },
    ],
    oRte: [
      function (require, module, exports) {
        var e = require('./_to-integer'),
    ...
    'T+Wj': [
      ...
      },
      {
        './_an-object': 'gBlm',
        './_to-length': 'rKjT',
        './_advance-string-index': 'DpK/',
        './_regexp-exec-abstract': '4CLI',
        './_fix-re-wks': 'QoXE',
      },
    ],
    X0aj: [
    ...
    aB0S: [
      ...
      { './_export': 'L1Pz', './_fails': 'fbBX', './_defined': 'iw5+' },
    ],
    Wjj3: [
      function (require, module, exports) {
        'use strict'
    ...
    Uh3D: [
      ...
      { './_export': 'L1Pz', './_string-pad': 'uiQ/', './_user-agent': 'C4Hq' },
    ],
    'Tj1+': [
      function (require, module, exports) {
        'use strict'
                  ...
                  for (;;)
                    switch ((n.prev = n.next)) {
                      ...
                      case 7:
                        ;(n.prev = 7),
                          (n.t0 = n.catch(0)),
                          (0, r.showAlert)('error', n.t0.response.data.message)
                      case 10:
                      case 'end':
                        return n.stop()
                    }
    ...
    FxPS: [
      function (require, module, exports) {
        ...
        var u = (function () {
          var n = a(
            regeneratorRuntime.mark(function n(s, a) {
              var u
              return regeneratorRuntime.wrap(
                function (n) {
                  for (;;)
                    switch ((n.prev = n.next)) {
                      case 0:
                        return (
                          ...
                          (n.next = 4),
                          (0, t.default)({ method: 'PATCH', url: u, data: s })
                        )
                      case 4:
                        'success' === n.sent.data.status &&
                          (0, r.showAlert)(
    ...
    Focm: [
        ...
        i &&
          ...
          m &&
            m.addEventListener('submit', function (e) {
              ...
              ;(0, s.updateSettings)({ name: r, email: o }, 'data')
            }),
          d &&
            d.addEventListener(
              'submit',
      ...
      {
        'core-js/modules/es6.array.copy-within': 's95x',
        'core-js/modules/es6.array.fill': 'JMur',
        'core-js/modules/es6.array.find': 'DVgS',
        'core-js/modules/es6.array.find-index': 'sQB3',
        'core-js/modules/es6.array.from': 'uV/T',
        'core-js/modules/es7.array.includes': 'XhQx',
        'core-js/modules/es6.array.iterator': 'R0Z1',
        'core-js/modules/es6.array.of': 'O361',
        'core-js/modules/es6.array.sort': 'TCVS',
        'core-js/modules/es6.array.species': 'YdDJ',
        'core-js/modules/es6.date.to-primitive': '5dEO',
        'core-js/modules/es6.function.has-instance': 'IFs1',
        'core-js/modules/es6.function.name': 'kO8w',
        'core-js/modules/es6.map': 'scRr',
        'core-js/modules/es6.math.acosh': 'mVyg',
        'core-js/modules/es6.math.asinh': 'JSXC',
        'core-js/modules/es6.math.atanh': 'cyt3',
        'core-js/modules/es6.math.cbrt': 'brlm',
        'core-js/modules/es6.math.clz32': 'kT76',
        'core-js/modules/es6.math.cosh': 'TO4X',
        'core-js/modules/es6.math.expm1': 'PplL',
        'core-js/modules/es6.math.fround': 'DTXs',
        'core-js/modules/es6.math.hypot': 'zM1+',
        'core-js/modules/es6.math.imul': 'sSEw',
        'core-js/modules/es6.math.log1p': '39TQ',
        'core-js/modules/es6.math.log10': 'p6WZ',
        'core-js/modules/es6.math.log2': 'wCoU',
        'core-js/modules/es6.math.sign': 'oYvZ',
        'core-js/modules/es6.math.sinh': 'N2rY',
        'core-js/modules/es6.math.tanh': 'cgNK',
        'core-js/modules/es6.math.trunc': 'X7iv',
        'core-js/modules/es6.number.constructor': '6Bsx',
        'core-js/modules/es6.number.epsilon': 'luZo',
        'core-js/modules/es6.number.is-finite': 'XgfH',
        'core-js/modules/es6.number.is-integer': 'U18y',
        'core-js/modules/es6.number.is-nan': 'AeAQ',
        'core-js/modules/es6.number.is-safe-integer': 'khEz',
        'core-js/modules/es6.number.max-safe-integer': 'dRhU',
        'core-js/modules/es6.number.min-safe-integer': '2BWF',
        'core-js/modules/es6.number.parse-float': 'BVwL',
        'core-js/modules/es6.number.parse-int': 'RN5j',
        'core-js/modules/es6.object.assign': 'q1Bq',
        'core-js/modules/es7.object.define-getter': '46Z3',
        'core-js/modules/es7.object.define-setter': 'Wcig',
        'core-js/modules/es7.object.entries': 'aNgU',
        'core-js/modules/es6.object.freeze': 'yoMt',
        'core-js/modules/es6.object.get-own-property-descriptor': '55hx',
        'core-js/modules/es7.object.get-own-property-descriptors': 'KZ7J',
        'core-js/modules/es6.object.get-own-property-names': 'FmSW',
        'core-js/modules/es6.object.get-prototype-of': 'eKPx',
        'core-js/modules/es7.object.lookup-getter': 'SmKU',
        'core-js/modules/es7.object.lookup-setter': 'lNWP',
        'core-js/modules/es6.object.prevent-extensions': 'EuFr',
        'core-js/modules/es6.object.is': '/n3o',
        'core-js/modules/es6.object.is-frozen': 'hoz0',
        'core-js/modules/es6.object.is-sealed': 'qCTx',
        'core-js/modules/es6.object.is-extensible': 'VhFU',
        'core-js/modules/es6.object.keys': '2U+P',
        'core-js/modules/es6.object.seal': 'cIJi',
        'core-js/modules/es6.object.set-prototype-of': 'UBTL',
        'core-js/modules/es7.object.values': 'lmEY',
        'core-js/modules/es6.promise': 'IKuy',
        'core-js/modules/es7.promise.finally': 'lqgY',
        'core-js/modules/es6.reflect.apply': 'rv6E',
        'core-js/modules/es6.reflect.construct': 'E/yi',
        'core-js/modules/es6.reflect.define-property': 'JSMr',
        'core-js/modules/es6.reflect.delete-property': 'vyYx',
        'core-js/modules/es6.reflect.get': '+Xwl',
        'core-js/modules/es6.reflect.get-own-property-descriptor': 'iOag',
        'core-js/modules/es6.reflect.get-prototype-of': 'aUcI',
        'core-js/modules/es6.reflect.has': 'FJ0f',
        'core-js/modules/es6.reflect.is-extensible': '450N',
        'core-js/modules/es6.reflect.own-keys': 'GxoL',
        'core-js/modules/es6.reflect.prevent-extensions': 'W8WG',
        'core-js/modules/es6.reflect.set': 'w2jp',
        'core-js/modules/es6.reflect.set-prototype-of': 'hcPy',
        'core-js/modules/es6.regexp.constructor': 'pQ0C',
        'core-js/modules/es6.regexp.flags': 'UHTP',
        'core-js/modules/es6.regexp.match': 'T+Wj',
        'core-js/modules/es6.regexp.replace': 'X0aj',
        'core-js/modules/es6.regexp.split': 'rSll',
        'core-js/modules/es6.regexp.search': 'tWkY',
        'core-js/modules/es6.regexp.to-string': 'Q8Ex',
        'core-js/modules/es6.set': 'RUEc',
        'core-js/modules/es6.symbol': '95CL',
        'core-js/modules/es7.symbol.async-iterator': 'boDi',
        'core-js/modules/es6.string.anchor': 'Wjj3',
        'core-js/modules/es6.string.big': 'qqKg',
        'core-js/modules/es6.string.blink': 'ih0q',
        'core-js/modules/es6.string.bold': '9sjz',
        'core-js/modules/es6.string.code-point-at': 'aXri',
        'core-js/modules/es6.string.ends-with': 'S9Ej',
        'core-js/modules/es6.string.fixed': '7Ul7',
        'core-js/modules/es6.string.fontcolor': 'S22g',
        'core-js/modules/es6.string.fontsize': 'o6MI',
        'core-js/modules/es6.string.from-code-point': 'asQ6',
        'core-js/modules/es6.string.includes': 'SxiA',
        'core-js/modules/es6.string.italics': 'zaWd',
        'core-js/modules/es6.string.iterator': 'BSat',
        'core-js/modules/es6.string.link': 'ID6l',
        'core-js/modules/es7.string.pad-start': 'Uh3D',
        'core-js/modules/es7.string.pad-end': 'Tj1+',
        'core-js/modules/es6.string.raw': 'IoUV',
        'core-js/modules/es6.string.repeat': 'pvEg',
        'core-js/modules/es6.string.small': 'OwgP',
        'core-js/modules/es6.string.starts-with': 'Tgrn',
        'core-js/modules/es6.string.strike': 'C3ft',
        'core-js/modules/es6.string.sub': 'zUU3',
        'core-js/modules/es6.string.sup': 'rFzE',
        'core-js/modules/es6.typed.array-buffer': 'QhR4',
        'core-js/modules/es6.typed.int8-array': 'snaB',
        'core-js/modules/es6.typed.uint8-array': 'eMMX',
        'core-js/modules/es6.typed.uint8-clamped-array': 'z1ek',
        'core-js/modules/es6.typed.int16-array': 'pR52',
        'core-js/modules/es6.typed.uint16-array': 'gES0',
        'core-js/modules/es6.typed.int32-array': '24x+',
        'core-js/modules/es6.typed.uint32-array': 'i+5w',
        'core-js/modules/es6.typed.float32-array': '0fRd',
        'core-js/modules/es6.typed.float64-array': 'RTJR',
        'core-js/modules/es6.weak-map': '3zxJ',
        'core-js/modules/es6.weak-set': '0n34',
        'core-js/modules/es7.array.flat-map': 'mVE7',
        'core-js/modules/web.timers': 'INLk',
        'core-js/modules/web.immediate': '1/Oo',
        'core-js/modules/web.dom.iterable': '2WWu',
        'regenerator-runtime/runtime': 'dgxz',
        './mapbox': 'g63L',
        './login': 'mnjM',
        './updateSettings': 'FxPS',
      },
